...
["freefire", "free fire", "standoff"] = 5
{
	"Moron?";
	"Fucked fool?";
	"Hope you don't eat this shit?";
	"Well, someone is born a freak!";
}

["xyi", "genitals", "genitalia", "penis", "vagina"] = 5
{
...
["music", "album", "dance", "dancing", "stereo", "speakers", "amplifier", "musician", "guitar"] = 4
{
	...
	"I love Eminem music.";
	"I love Nirvana music.";
	"I love Linkin park music.";
	"I love Rammstein music.";
...
["negro", "nigger", "niggers", "negros", "negroes"] = 5
{
	...
	"The Saw will prove that we are inside the same color";
 ...
 "devine", "graeme", "xian", "disruptor", "christian antkow", "kaai", "kaai cluney", "aaron seeler", "zoid"] = 9
{
	...
	"This is the elite so show respect!";
