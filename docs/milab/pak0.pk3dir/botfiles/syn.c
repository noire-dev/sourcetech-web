...
CONTEXT_NEARBYITEM
{
	...
	[("Shotgun", 1), ("shotgun", 0.5), ("boom stick", 0.7), ("scatter gun", 0.3)]
	[("Machinegun", 1), ("machinegun", 0.5), ("pop gun", 0.3)]
	[("Grenade Launcher", 1), ("grenade", 0.5)]
	[("Rocket Launcher", 1), ("rocket", 0.5)]
	[("Lightning Gun", 1), ("lightning", 0.2)]
	[("Plasma Gun", 1), ("plasmagun", 0.3), ("blue balls of doom", 0.2)]
	[("Railgun", 1), ("railgun", 0.5), ("camping tool", 0.2)]
	[("BFG10K", 1), ("bfg", 0.1), ("crowd control", 0.4)]
	[("Nailgun", 1), ("nailgun", 0.1), ("nail shooter", 0.5)]
	[("Prox Launcher", 1), ("mines", 0.2), ("mine layer", 0.5)]
	[("Chaingun", 1), ("chaingun", 0.5), ("big pop gun", 0.4)]
	[("Flamethrower", 1), ("flamethrower", 0.5), ("flame gun", 0.4)]
	[("Dark Flare", 1), ("darkflare", 0.5), ("dark gun", 0.4)]
